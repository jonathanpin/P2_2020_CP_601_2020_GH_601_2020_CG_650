    ...
    public class departamentosController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var departamentos = await _context.departamentos
                .FirstOrDefaultAsync(m => m.id_departamentos == id);
        ...
        public async Task<IActionResult> Create([Bind("id_departamentos,nombre_departamento")] departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_departamentos,nombre_departamento")] departamentos departamentos)
        {
            if (id != departamentos.id_departamentos)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!departamentosExists(departamentos.id_departamentos))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.departamentos?.Any(e => e.id_departamentos == id)).GetValueOrDefault();
        }
    }
}
